...
use Thibaultvanc\Chat\Http\Requests\DestroyConversation;
use Thibaultvanc\Chat\Http\Requests\StoreConversation;
use Thibaultvanc\Chat\Http\Requests\UpdateConversation;
